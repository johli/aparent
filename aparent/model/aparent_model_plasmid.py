...
def load_aparent_model(batch_size, use_sample_weights=False) :
    ...
    layer_dense = Dense(256, activation='relu')#(Concatenate()([Flatten()(layer_2), distal_pas_input]))
    layer_drop = Dropout(0.2)
    #layer_dense2 = Dense(512, activation='relu')
    ...
    return [ ('plasmid_iso_cut_distalpas', plasmid_model), ('loss', loss_model) ]
