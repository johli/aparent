...
for sample in samples :
	...
	while not os.path.exists('/home/johli/apa_snp/geuvadis/' + sample + '_bamprocessor1_complete.txt') :
		time.sleep(5)
	...
	subprocess.call(shlex.split('rm geuvadis/' + sample + '_bamprocessor1_complete.txt'))
