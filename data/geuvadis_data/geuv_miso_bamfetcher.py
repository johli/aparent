...
for sample in samples :
	...
	if os.path.exists('/home/johli/apa_snp/geuvadis/' + sample + '_summary') :
		continue
	if os.path.exists('/home/johli/apa_snp/geuvadis/' + sample + '_bamfetcher_complete.txt') :
		continue
	...
	subprocess.call(shlex.split('touch /home/johli/apa_snp/geuvadis/' + sample + '_bamfetcher_complete.txt'))