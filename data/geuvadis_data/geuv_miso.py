...
for sample in sample_bam :
	...
	#subprocess.call(shlex.split('wget -O /home/johli/apa_snp/geuvadis/' + bam_file + ' \"' + ftp_address + '\"'))
	#http://www.ebi.ac.uk/arrayexpress/files/E-GEUV-1/HG00096.1.M_111124_6.bam
	subprocess.call(shlex.split('wget -O /home/johli/apa_snp/geuvadis/' + bam_file + ' \"http://www.ebi.ac.uk/arrayexpress/files/E-GEUV-1/' + bam_file + '\"'))

	subprocess.call(shlex.split('samtools sort /home/johli/apa_snp/geuvadis/' + bam_file + ' /home/johli/apa_snp/geuvadis/' + file_name + '.sorted'))
	subprocess.call(shlex.split('samtools index /home/johli/apa_snp/geuvadis/' + file_name + '.sorted.bam'))

	subprocess.call('samtools view geuvadis/' + file_name + '.sorted.bam | head -n 1000000 | cut -f 10 | perl -ne \'chomp;print length($_) . "\n"\' | sort | uniq -c > geuvadis/' + sample + '_readlength.txt', shell=True)
