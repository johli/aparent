...
for sample in samples :
	...
	if os.path.exists('/home/johli/apa_snp/geuvadis/' + sample + '_summary') :
		continue
	if os.path.exists('/home/johli/apa_snp/geuvadis/' + sample + '_bamindexer_complete.txt') :
		continue
	...
	while not os.path.exists('/home/johli/apa_snp/geuvadis/' + sample + '_bamfetcher_complete.txt') :
		time.sleep(5)
	...
	subprocess.call(shlex.split('touch /home/johli/apa_snp/geuvadis/' + sample + '_bamindexer_complete.txt'))